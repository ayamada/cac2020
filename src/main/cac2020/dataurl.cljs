...
;;; 煙/雲。32x32。
(defn smoke []
  (t (util/str* "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAYAAAAf"
...
;;; 葉。16x16
(defn leaf []
  (t (util/str* "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQAgMAAABi"
...
;;; p8金髪緑服。11x15。
(defn p8elf []
  (t (util/str* "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAsAAAAPCAYAAAAy"
